...
const studentSteps: Step[] = [
  {
    ...
    description: "Students in 10th class from Govt. & Aided High Schools appear for a screening test conducted at Mandal Headquarters.",
    highlight: "Annual test",
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    description: "Selected students receive scholarship funding to continue their Intermediate or equivalent course for 2 years.",
    highlight: "2-year support",
  },
  {
    icon: Rocket,
    title: "Guidance & Growth",
    description: "We advise students and guide them in securing admission for undergraduate courses, with continued financial support.",
    highlight: "Ongoing mentorship",
  },
]
...
const donorSteps: Step[] = [
  {
    ...
    description: "Donate through Vidyonnati Foundation and help deserving meritorious students from the area of your choice in AP.",
    highlight: "Any amount",
  },
  {
    icon: Users,
    title: "Student Matching",
    description: "Your contribution is directed to screened, merit-selected students from Government High Schools in rural areas.",
    highlight: "Verified students",
  },
  {
    icon: BarChart3,
    title: "Track Progress",
    description: "Receive updates on your sponsored student's academic progress and achievements throughout their education.",
    highlight: "Regular updates",
  },
  {
    icon: FileText,
    title: "Tax Benefits",
    description: "Get 80G tax exemption certificates. All donations are fully documented with complete transparency.",
